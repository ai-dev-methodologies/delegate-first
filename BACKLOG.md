...
**현재 상태 요약 (2026-08-21)**: 총 17건 중 13건 해결(B-01·B-02·B-03·B-06·B-07·B-08·B-09·B-10·B-11·B-12·B-13·B-14·B-16). 남은 4건은 B-04(플러그인화, 트리거 미도달로 착수 보류), B-05(fable 트리거 5종 실전 검증 기록, 조치 불필요·관찰 기록), B-15·B-17(REINSTALL 롤백의 agents 축 결함군 잔여 — 2026-08-21 codex critic 발견, 보류). B-16은 같은 발견 라운드였지만 이번 PR에서 단독 봉합됐다(B-15·B-17과 달리 매니페스트 설계 없이도 rm/복원 대칭화만으로 고칠 수 있는 결함이었다). 해결 항목들은 삭제하지 않고 이력 보존용으로 남겨둔다.
...
**상태**: 미해결 — 보류(2026-08-21 codex critic 발견). · **우선순위**: 2
...
**상태**: 미해결 — 보류(2026-08-21 codex critic 발견, B-15와 같은 PR에서 처리). · **우선순위**: 2
